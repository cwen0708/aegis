  ...
  <div class="space-y-6">
    ...
    <div class="bg-slate-800/50 rounded-2xl border border-slate-700 overflow-hidden">
      ...
      <div class="p-6 space-y-4">
        ...
        <!-- 裝置名稱（選填） -->
        <div>
          <label class="block text-xs font-medium text-slate-400 mb-1.5">裝置名稱（選填）</label>
          <input
            v-model="form.device_name"
            type="text"
            placeholder="預設使用 OneStack 上設定的名稱"
            class="w-full bg-slate-900 border border-slate-700 rounded-lg p-2.5 text-slate-200
              focus:ring-2 focus:ring-cyan-500 outline-none text-sm"
          />
        </div>
