...
import { Settings, Globe, Terminal, TerminalSquare, MessageSquare, Users, UserCheck, Bot, Activity, Lock, Loader2, FolderKanban, Mail, ChevronDown, Download, Layers, Rocket } from 'lucide-vue-next'
